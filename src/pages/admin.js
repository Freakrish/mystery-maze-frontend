...
const Login = (props) => {
  ...
  const onSubmit = async (event) => {
    ...
    if (
      email.toLowerCase() === process.env.REACT_APP_ADMIN_EMAIL &&
      password.toLowerCase() === process.env.REACT_APP_ADMIN_PASSWORD
    ) {
    ...
    <div className="authenti-main">
      <header className="authenti">
        ...
        <div className="authenti-content">
          <h1 className="authenti-title">Mystery Maze</h1>
...
const AdminConsole = (props) => {
  ...
  useEffect(() => {
    try {
      axios.get(`${process.env.REACT_APP_BACKEND_URL}result`).then((res) => {
    ...
    <div className="leader-main">
      ...
      >
        <div class="container-fluid">
          <h5 className="navbar-brand leader-nav-heading admin-nav-heading-new">
            Mystery Maze
          </h5>
